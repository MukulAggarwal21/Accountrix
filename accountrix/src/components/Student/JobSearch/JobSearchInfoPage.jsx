      ...
      <div className="bg-white rounded-xl shadow-lg  flex flex-col lg:flex-row w-full max-w-7xl">
        ...
        <div className="w-full lg:w-2/3 p-6 ">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-lg">Lucio AI <span className="text-green-600">• Actively Hiring</span></h2>
          ...
          <h1 className="mt-4 text-xl font-bold">Frontend Engineer (2+ yrs of exp in React.js)</h1>
          <p className="text-gray-700 mt-1">₹10L – ₹20L • No equity | Remote • Bangalore Urban | 2 years of exp | Full Time</p>
        ...
        <div className="w-full lg:w-1/3 border-t lg:border-t-0 lg:border-l p-6 bg-gray-50">
          <h2 className="font-semibold text-lg mb-3">Apply to Lucio AI</h2>
