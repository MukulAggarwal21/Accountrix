  ...
  return (
    <>
      ...
      <div className="flex justify-center space-x-4">
        <button onClick={() => {
          navigate('/dashboard')
        }} className="px-6 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all duration-200">
          View Dashboard
        </button>
        <button onClick={() => {
          navigate('/jobposting')
        }} className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 shadow-md transition-all duration-300">
          Post Your First Job
        </button>
      </div>
    </>
