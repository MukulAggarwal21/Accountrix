...
const Newsletter = () => {
  return (
    <section className="py-16 bg-gradient-to-r from-green-100 to-blue-100 text-white">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold mb-4 text-blue-800">Stay Updated</h2>
        <p className="mb-6 text-black">Subscribe to our newsletter for the latest job updates and career tips.</p>
        <form className="flex flex-col md:flex-row justify-center items-center gap-4">
          <input
            type="email"
            placeholder="Enter your email"
            className="px-4 py-3 rounded-lg border-solid border-2 border-black text-gray-800 w-full md:w-1/2"
          />
          <button className="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-3 rounded-lg font-medium transition">
            Subscribe
          </button>
